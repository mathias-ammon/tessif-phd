    ...
    'transformers': {
        'transformerA': {
            ...
            'timeseries': {
                ...
                'electricity': nts.MinMax(min=[1, 2, 3, 4, 5, 4, 3, 2, 9, 0], max=[1, 2, 3, 4, 5, 4, 3, 2, 9, 0]),
            },  # but maximum flow forced
        },
        'transformerB': {
            'name': 'transformer2',
            'inputs': ('chemical_energy',),
...
}  # minimum working example source - linear - timeseries max matze
