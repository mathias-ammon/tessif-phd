...
# asccumulated, both transormers cant meet sinks electricity demand, both are expandable with different expansion_costs
# source2 feeds sinks directly but with high flow_costs
# expected behaviour: transormers feed sinks electricity demand until limited fuel flow_rate is reached (5 entities electricity per timestep due to conversion) remaining demand will be given by trans 2 due to lower expansion_costs
...
}  # minimum working example transformer - linear - expansion_costs
