...
mapping = {
    ...
    'storages': {
        'storageA': {
            ...
            'expansion_limits': {
                "capacity": nts.MinMax(min=5, max=50),
                'electricity': nts.MinMax(min=5, max=50)
            },
        ...
        'storageB': {
            ...
            # storage 2 is cheaper to expand
        },
    },
    'busses': {
        'bus': {
...
}  # minimum working example storage - expansion - expansion_costs.py
