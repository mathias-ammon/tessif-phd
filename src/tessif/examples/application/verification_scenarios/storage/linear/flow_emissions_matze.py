...
mapping = {
    ...
    'storages': {
        'storageA': {
            ...
            # 22 energy units are discharged due to emission constraints
            # remaining demand is met by the more expansive source2
        },
    },
    'busses': {
        'bus': {
...
}  # minimum working example storage - linear - flow_emissions_matze
