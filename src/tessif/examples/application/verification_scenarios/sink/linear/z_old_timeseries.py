...
mapping = {
    ...
    'sinks': {
        'sinkA': {
            ...
            'timeseries': {'electricity': nts.MinMax(min=[50, 40, 30, 20, 10, 0, 0, 0, 0, 0,], max=[50, 40, 30, 20, 10, 0, 0, 0, 0, 0,])}, # flow_rate limited
        },
        'sinkB': {
            'name': 'sink2',
            'inputs': ('electricity',),
...
}  # minimum working example sink - linear - timeseries
