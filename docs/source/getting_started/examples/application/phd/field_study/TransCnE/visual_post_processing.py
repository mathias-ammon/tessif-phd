...
rel_installed_capacities = all_installed_capacities.div(
    all_installed_capacities["omf"], axis="index")
rel_installed_capacities = rel_installed_capacities.round(2)
...
rel_emissions_caused = rel_emissions_caused.round(2)
